...
const DeletePrice: FC<DeletePriceProps> = ({ closeView, confirmAction }) => {
    return (
        <ModalLayout closeView={closeView}>
        
            <div className="bg-slate-100 p-3 text-slate-600 font-semibold">Confirm Request</div>
            <div className="text-center w-4/5 my-6 mx-auto">Are you sure you want to <span className="text-light text-sm bg-red-400/20 rounded-lg py-1 font-semibold capitalize px-3">delete</span> this Price</div>
